...
//    public function actionSeleksi1() {
...
//        //search lits of pelamar from lamaran
//        $modelsP = array();
//        //each of list lamaran load model Pelamar
//        foreach ($modelsL as $j => $item) {
//            $modelsP[$j] = new Pelamar;
//            $modelsP[$j] = $this->loadModel($item->id_pelamar);
//        }
//        //parese two model to view pelamar management
//        $this->render('seleksi1', array(
//            'modelsL' => $modelsL, 'modelsP' => $modelsP,
//        ));
//    }
//
//    public function actionSeleksi2() {
//        //manggil seluruh tahap yang ada di database
//        //ngeload pelamar
//    }
//
    /**

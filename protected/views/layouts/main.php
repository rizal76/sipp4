								...
								if(!Yii::app()->user->isGuest) {
								    // MENU FOR SUPER ADMIN ////
								     if(Yii::app()->user->isSuperAdmin()) {
								     	...
								     	echo "<li>"; echo CHtml::link('Lowongan', array('/lowongan/admin'));  echo "</li>";
								     	echo "<li>"; echo CHtml::link('Pelamar', array('/pelamar/admin'));  
								     	echo "<ul class='dropdown'>";
								     		echo "<li>"; echo CHtml::link('Daftar Pelamar',  array('/pelamar/admin')); echo "</li>";
								     		echo "<li>"; echo CHtml::link('Seleksi Administrasi',  array('lamaran/seleksiDokumen')); echo "</li>";
								     		echo "<li>"; echo CHtml::link('Seleksi Lanjut', array('lamaran/seleksiLanjut')); echo "</li>";
								     	echo "</ul>";
								     	echo "</li>";
								    ...
								    // MENU FOR ADMIN ////
									    ...
									    echo "<li>"; echo CHtml::link('Pengumuman', array('/lamaran/pengumuman'));  echo "</li>";
									    echo "<li class=\"logout\">"; echo CHtml::link('Logout', array('/site/logout'));  echo "</li>";
									}
